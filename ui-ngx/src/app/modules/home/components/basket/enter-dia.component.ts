...
@Component({
  selector: 'tb-enter-dia',
  templateUrl: './enter-dia.component.html',
  styleUrls: ['./enter-dia.component.scss']
})
export class EnterDiaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<EnterDiaComponent>,
  ...
  //下载模板
  downloadModel() {
    this.BasketService.fetchDownloadModel().subscribe(res => {
