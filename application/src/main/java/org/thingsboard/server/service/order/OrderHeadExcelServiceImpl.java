...
//        List<TSysClass> sysClassList = new ArrayList<>();
            ...
            if (tSysCraftProcessRelList.size() <= 0) {
                ...
                TSysCraftProcessRel tSysCraftProcessRel = tSysCraftProcessRelList.get(0);
                //获取工序
...
//                    tBusOrderProcess.setPersonId(personnelInfo);
    ...
    public void startOrderBatch(List<OrderStartOrderSaveDto> saveDtoList) throws Exception {
        for (OrderStartOrderSaveDto saveDto:saveDtoList) {
            TSysCraftInfo craft = this.getCraftInfoByMaterial(saveDto.getBodyMaterialNumber(),saveDto.getOrderId());
            this.startOrder(saveDto.getOrderId(),craft.getCraftId(),saveDto.getCraftDesc());
        }
    }
...
//        var tBusOrderProcessSetRt = orderProcessRepository.saveAll(tBusOrderProcessSet);
    ...
    public TSysCraftInfo getCraftInfoByMaterial(String materialNumber,Integer orderId) {
        //获取物料
