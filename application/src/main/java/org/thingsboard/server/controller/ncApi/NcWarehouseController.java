...
@RestController
@RequestMapping("/outapi/nc/warehouse")
@Api(tags = "NC仓库接口")
public class NcWarehouseController {
    @Autowired
    private NcWarehouseService service;

    @ApiOperation("批量新增/更新仓库")
    ...
    public ResponseResult create(@RequestBody List<NcWarehouse> entitys) {
