...
public class OvenDeviceRunVo extends BaseRowModel {
    ...
    @ExcelProperty(value = "总平均温度", index = 12)
    @ApiModelProperty("总平均温度(导出专用)")
    private String avgTempExport;

    @ExcelProperty(value = "超标次数", index = 13)
    ...
    @ExcelProperty(value = "达标率", index = 14)
    ...
    @ExcelProperty(value = "平均速度", index = 15)
    ...
    @ExcelProperty(value = "平均热风频率", index = 16)
    @ApiModelProperty("平均热风频率（导出专用）")
    private String  avgHotWindExport;

    @ExcelProperty(value = "故障次数", index = 17)
