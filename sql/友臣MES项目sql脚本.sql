...
CREATE TABLE t_sys_user_detail (
                                   ...
                                   nc_warehouse_id varchar(255) NULL, -- 仓库ID
                                   nc_warehouse_name varchar(255) NULL, -- 仓库名称
...
COMMENT ON COLUMN public.t_sys_user_detail.nc_warehouse_id IS '仓库ID';
COMMENT ON COLUMN public.t_sys_user_detail.nc_warehouse_name IS '仓库名称';
